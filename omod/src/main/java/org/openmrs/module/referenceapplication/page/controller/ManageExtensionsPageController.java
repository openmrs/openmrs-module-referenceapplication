...
public class ManageExtensionsPageController {
	...
	private void addModelAttributes(PageModel model, AppFrameworkService service) {
	    ...
	    //GETING ALL THE ENABLED EXTENSIONS
	    List<Extension> allEnabledExtensions=service.getAllEnabledExtensions();
		
		model.addAttribute("extensions", allEnabledExtensions);
	}
