...
public class ManageExtensionsPageController {
	...
	private void addModelAttributes(PageModel model, AppFrameworkService service) {
		List<Extension> allExtensions = service.getAllExtensions();
		...
		for (Extension ex : allExtensions) {
			extensions.add(new ExtensionModel(ex.getId(), enabledExtensions.contains(ex)));
		}
	...
	public class ExtensionModel {
		...
		public ExtensionModel(String id, boolean enabled) {
